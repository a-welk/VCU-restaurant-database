...
erDiagram
    ...
    dietary_preference {
        ...
        varchar(256) dietary_preference_name
        --
    ...
    locations {
        int location_id
        varchar(256) location_address
        varchar(32) location_direction_from_VCU
        varchar(256) location_neighborhood
        --
        PK(location_id)
    }
    ...
    restaurants {
        int restaurant_id
        varchar(256) restaurant_name
        varchar(256) restaurant_formality_level
        varchar(32) restaurant_avg_total_per_person
        int restaurant_location_id
        varchar(256) restaurant_type
        --
        PK(restaurant_id)
        FK(restaurant_location_id) REFERENCES locations(location_id)
    }
    ...
    review {
        ...
        float review_rating
        varchar(1026) review_text
        date review_date
        --
        PK(review_id)
        FK(review_restaurant_id) REFERENCES restaurants(restaurant_id)
    }
    ...
    accessibility {
        ...
        varchar(256) accessibility_nearby_bus_stops
        varchar(256) accessibility_notes
        --
        PK(accessibility_id)
        FK(accessibility_restaurant_id) REFERENCES restaurants(restaurant_id)
    }
    ...
    menu {
        ...
        --
        PK(menu_id)
        FK(restaurant_id) REFERENCES restaurants(restaurant_id)
    }

    item {
        int item_id
        int item_dietary_preference_id
        varchar(256) item_name
        varchar(512) item_description
        float item_price
        --
        PK(item_id)
        FK(item_dietary_preference_id) REFERENCES dietary_preference(dietary_preference_id)
    }
    ...
    menu_items {
        ...
        FK(item_id) REFERENCES item(item_id)
    }
