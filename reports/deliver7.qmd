...
This query retrieves affordable menu items containing "chicken" in their names, displaying their names, descriptions, prices, and the respective restaurant names, sorted by price from least to most expensive.
```{python}
#| echo: false
#| eval: true
sql = f"""
